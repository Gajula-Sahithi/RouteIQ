  ...
  return (
    <Layout>
      <div className="space-y-12 pb-20 max-w-7xl">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 bg-[var(--bg-tertiary)]/40 p-10 rounded-3xl border border-[var(--border-primary)]">
          <div>
          ...
          {[
            ...
            <div key={i} className="card-premium p-8 flex flex-col justify-between h-44">
               <div className="flex justify-between items-start">
                  <div className={`p-3 rounded-lg bg-[var(--bg-tertiary)] border border-[var(--border-primary)] ${stat.color}`}>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 h-[500px]">
           <div className="xl:col-span-2 card-premium p-0 overflow-hidden flex flex-col">
              <div className="p-8 border-b border-[var(--border-primary)] bg-[var(--bg-tertiary)]/50">
                 <h3 className="text-sm font-black text-[var(--text-primary)] uppercase tracking-widest">Environmental Corridor Audit</h3>
              </div>
           ...
           <div className="card-premium p-8 flex flex-col items-center justify-center text-center">
              <div className="relative w-40 h-40 flex items-center justify-center mb-8">
                 ...
                 <div>
                    <p className="text-5xl font-black text-[var(--text-primary)] tracking-tighter">A<span className="text-blue-500 font-medium">+</span></p>
                    <p className="text-[9px] text-[var(--text-secondary)] font-black uppercase tracking-widest mt-2">ESG Rating</p>
                 </div>
              </div>
              <div className="space-y-4 w-full">
                 <div className="p-4 rounded-xl bg-[var(--bg-tertiary)] border border-[var(--border-primary)] flex justify-between items-center">
                    <span className="text-[9px] font-black text-[var(--text-tertiary)] uppercase tracking-widest">Neutrality Goal</span>
                    <span className="text-sm font-black text-[var(--text-primary)]">82%</span>
                 </div>
                 <div className="p-4 rounded-xl bg-[var(--bg-tertiary)] border border-[var(--border-primary)] flex justify-between items-center">
                    <span className="text-[9px] font-black text-[var(--text-tertiary)] uppercase tracking-widest">Biofuel Adoption</span>
                    <span className="text-sm font-black text-[var(--text-primary)]">14%</span>
                 </div>
              </div>
           </div>
        </div>
